...
class Quotes extends CI_Model {
	...
	var $data = array(
		...
		array('id' => '6', 'who' => 'Isaac Asimov', 'mug' => 'isaac-asimov-150x150.jpg', 'where' => '/comp4711/wisdom',
         ...
         array('id' => '7', 'who' => 'Thomas Keller', 'mug' => 'Thomas-Keller-150x150.jpg', 'where' => '/chef',
			'what' => 'Once you understand the foundations of cooking - whatever kind you like, whether it\'s French or Italian or Japanese - you really don\'t need a cookbook anymore.')
	);
